    ...
    <div class="summary-shell page-with-fixed-nav px-3 px-md-4 py-4">
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Edit User</div>
                    <div class="mt-2 text-white-50">
                        Update user information, role assignment, account status, and security settings.
                    </div>
                </div>
        ...
        <div class="row g-4">
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Review and update the user account details below.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <form action="{{ route('users.update', $user) }}" method="POST">
                            ...
                            <div class="mt-4 d-flex gap-2 flex-wrap">
                                <button type="submit" class="btn btn-summary-primary">Update User</button>
            ...
            <div class="col-lg-4">
                ...
                <div class="meta-card mb-4">
                    <div class="meta-label">Current Email</div>
                    <div class="meta-value">{{ $user->email ?? '-' }}</div>
                </div>

                <div class="meta-card mb-4">
                    <div class="meta-label">Current Status</div>
                    <div class="meta-value">{{ ucfirst($user->status ?? 'active') }}</div>
                </div>

                <div class="helper-box mb-4">
                    <div class="helper-box-title">Edit Guidance</div>
                    <ul>
                        <li>Review the user’s email carefully because it affects login access.</li>
                        <li>Assign the correct role to match the user’s responsibilities.</li>
                        <li>Leave password blank if you do not want to change current credentials.</li>
                        <li>Status changes may affect whether the user can access the system.</li>
                    </ul>
                </div>
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            User records affect permissions, access scope, and administrative security.
                        </div>
                    </div>

                    <div class="form-panel">
                        <div class="mb-3">
                            <div class="fw-bold mb-1">Access Control</div>
                            <div class="text-muted small">
                                Role updates determine what pages, actions, and reports the user can access.
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-muted small">
                                Proper user setup keeps permissions aligned with actual responsibilities.
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="text-muted small">
                                Careful updates help maintain a secure and well-managed superadmin environment.
                            </div>
                        </div>
                    </div>
                </div>
