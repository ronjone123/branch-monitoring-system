        ...
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Add User</div>
                    <div class="mt-2 text-white-50">
                        Create a new system user and assign the correct role, access scope, and account status.
                    </div>
                </div>
        ...
        <div class="row g-4">
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Enter the required user account details below.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <form action="{{ route('users.store') }}" method="POST">
                            ...
                            <div class="mt-4 d-flex gap-2 flex-wrap">
                                <button type="submit" class="btn btn-summary-primary">Save User</button>
            ...
            <div class="col-lg-4">
                <div class="helper-box mb-4">
                    ...
                    <ul>
                        <li>Use the user’s official name and active email address.</li>
                        <li>Assign the correct system role based on responsibilities.</li>
                        <li>Review branch or scope-related assignments carefully.</li>
                        <li>Set the right status before saving the account.</li>
                    </ul>
                </div>
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            User accounts affect access control, monitoring visibility, and administrative security.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <div class="mb-3">
                            ...
                            <div class="text-muted small">
                                User setup determines which pages, reports, and actions are available in the system.
                            </div>
                        </div>

                        <div class="mb-3">
                            <div class="fw-bold mb-1">Operational Scope</div>
                            <div class="text-muted small">
                                Role and assignment settings control what data the user can review or manage.
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="text-muted small">
                                Correct user setup helps keep the system organized, secure, and aligned with company roles.
                            </div>
                        </div>
                    </div>
                </div>
