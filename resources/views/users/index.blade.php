<x-app-layout>
    ...
    <div class="summary-shell page-with-fixed-nav px-3 px-md-4 py-4">
        ...
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Users</div>
                    <div class="mt-2 text-white-50">
                        Manage system users, role assignments, and account status across the platform.
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-end mb-4">
            <a href="{{ route('users.create') }}" class="btn btn-summary-primary">
                Add User
            </a>
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $users->total() }}</div>
                    <div class="summary-stat-sub">All user records currently listed in the system</div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $users->currentPage() }}</div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $users->count() }}</div>
                    <div class="summary-stat-sub">Number of users shown on this page</div>
                </div>
            </div>
        </div>
        ...
        <div class="summary-card">
            <div class="summary-section-header">
                ...
                <div class="summary-section-subtitle">
                    Review user accounts, emails, role assignments, and current status.
                </div>
            </div>

            <div class="summary-toolbar d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                <div class="text-muted small">
                    Showing <strong>{{ $users->count() }}</strong> record(s) on this page out of
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="action-group">
                                            <a href="{{ route('users.show', $user) }}" class="btn btn-sm btn-outline-secondary btn-summary-outline-sm">
                                                View
                                            </a>
                                            <a href="{{ route('users.edit', $user) }}" class="btn btn-sm btn-outline-primary btn-summary-outline-sm">
                                                Edit
                                            </a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="5" class="p-0">
                                        <div class="empty-state">
                                            ...
                                            <div>No system user records are available yet.</div>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
