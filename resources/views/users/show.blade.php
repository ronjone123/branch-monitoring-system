    ...
    <div class="summary-shell page-with-fixed-nav px-3 px-md-4 py-4">
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">User Details</div>
                    <div class="mt-2 text-white-50">
                        Review user account information, role assignment, status, and record timestamps.
                    </div>
                </div>

                <div class="summary-date-box d-flex flex-column justify-content-center align-items-center px-4 py-4">
                    <div class="summary-date-label">User</div>
                    <div class="summary-date-value">{{ $user->name }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div class="d-flex gap-2 flex-wrap">
                <a href="{{ route('users.edit', $user) }}" class="btn btn-summary-primary">
                    Edit User
                </a>
                <a href="{{ route('users.index') }}" class="btn btn-outline-secondary btn-summary-outline">
                    Back to List
                </a>
            </div>
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $user->name }}</div>
                    <div class="summary-stat-sub">Registered account name</div>
                </div>
            </div>

            <div class="col-md-4">
                <div class="summary-stat">
                    <div class="summary-stat-label">Role</div>
                    <div class="summary-stat-value">{{ $user->role->name ?? '-' }}</div>
                    <div class="summary-stat-sub">Assigned system role</div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ ucfirst($user->status) }}</div>
                    <div class="summary-stat-sub">Current account status</div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Core identity, access role, and timeline details for this account.
                        </div>
                    </div>
                        ...
                        <div class="detail-list">
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">
                                    <span class="soft-badge {{ $user->status === 'active' ? 'success' : 'secondary' }}">
                                        {{ ucfirst($user->status) }}
                                    </span>
                                </div>
                            </div>
            ...
            <div class="col-lg-4">
                <div class="helper-box mb-4">
                    <div class="helper-box-title">User Notes</div>
                    <ul>
                        <li>User records affect permissions, access control, and operational visibility.</li>
                        <li>Email should remain correct because it is used for login and identification.</li>
                        <li>Role and status changes directly affect what the user can access in the system.</li>
                    </ul>
                </div>
