        ...
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Add Location</div>
                    <div class="mt-2 text-white-50">
                        Create a new location record and define its code, municipality, province, and operational status.
                    </div>
                </div>
        ...
        <div class="row g-4">
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Enter the required location details below.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <form action="{{ route('locations.store') }}" method="POST">
                            ...
                            <div class="mt-4 d-flex gap-2 flex-wrap">
                                <button type="submit" class="btn btn-summary-primary">Save Location</button>
            ...
            <div class="col-lg-4">
                <div class="helper-box mb-4">
                    ...
                    <ul>
                        <li>Use the official code and location name.</li>
                        <li>Fill in city or municipality and province consistently.</li>
                        <li>Set the correct status before saving.</li>
                        <li>Location records affect branch assignment and reporting structure.</li>
                    </ul>
                </div>
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Location records influence branch setup and monitoring organization.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <div class="mb-3">
                            ...
                            <div class="text-muted small">
                                Branches rely on valid location records for correct master data setup.
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-muted small">
                                Location data helps organize filters, views, and branch grouping.
                            </div>
                        </div>

                        <div>
                            <div class="fw-bold mb-1">Operational Consistency</div>
                            <div class="text-muted small">
                                Standardized location records improve administrative accuracy across the system.
                            </div>
                        </div>
                    </div>
                </div>
