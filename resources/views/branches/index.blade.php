<x-app-layout>
    ...
    <div class="summary-shell page-with-fixed-nav px-3 px-md-4 py-4">
        ...
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Branches</div>
                    <div class="mt-2 text-white-50">
                        Manage branch master records, status, locations, and business unit assignments.
                    </div>
                </div>
        ...
        <div class="d-flex flex-column flex-sm-row align-items-start align-items-sm-center justify-content-between gap-3 mb-4">
            <a href="{{ route('branches.create') }}" class="btn btn-summary-primary branch-action-btn">
                Add Branch
            </a>
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-4">
                <div class="summary-stat">
                    <div class="summary-stat-label">Total Branches</div>
                    <div class="summary-stat-value">{{ $branches->total() }}</div>
                    <div class="summary-stat-sub">All branch records currently listed in the system</div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $branches->currentPage() }}</div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $branches->count() }}</div>
                    <div class="summary-stat-sub">Number of branch records shown on this page</div>
                </div>
            </div>
        </div>
        ...
        <div class="summary-card">
            <div class="summary-section-header">
                ...
                <div class="summary-section-subtitle">
                    Review branch codes, business units, locations, spreadsheet sheet names, and current status.
                </div>
            </div>

            <div class="summary-toolbar d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                <div class="text-muted small">
                    Showing <strong>{{ $branches->count() }}</strong> record(s) on this page out of
                    <strong>{{ $branches->total() }}</strong> total
                </div>
            </div>
                    ...
                    <table class="table report-table align-middle">
                        ...
                        <tbody>
                            @forelse($branches as $branch)
                                <tr>
                                    <td>
                                        <span class="soft-badge secondary">{{ $branch->code }}</span>
                                    </td>

                                    <td>
                                        <div class="branch-name">{{ $branch->display_name }}</div>
                                    </td>
                                        ...
                                        <div class="action-group">
                                            ...
                                            @if($branch->status !== 'closed')
                                                <form action="{{ route('branches.update', $branch) }}" method="POST" class="d-inline">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-sm btn-outline-danger btn-summary-outline-sm"
                                ...
                                <tr>
                                    <td colspan="7" class="p-0">
                                        <div class="empty-state">
                                            ...
                                            <div>No branch master records are available yet.</div>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
