        ...
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Add Branch</div>
                    <div class="mt-2 text-white-50">
                        Create a new branch record and assign its business unit, location, and spreadsheet mapping details.
                    </div>
                </div>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="summary-card">
                    <div class="summary-section-header">
                        <h5>Branch Information Form</h5>
                        <div class="summary-section-subtitle">
                            Enter the required branch details below to create a new branch record.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <form action="{{ route('branches.store') }}" method="POST">
                            ...
                            <div class="mt-4 d-flex gap-2 flex-wrap">
                                <button type="submit" class="btn btn-summary-primary">Save Branch</button>
            ...
            <div class="col-lg-4">
                <div class="helper-box mb-4">
                    <div class="helper-box-title">Branch Setup Guidance</div>
                    <ul>
                        <li>Use the official branch code and display name.</li>
                        <li>Assign the correct business unit and location.</li>
                        <li>Match the spreadsheet sheet name exactly when needed for imports.</li>
                        <li>Review status before saving the new branch record.</li>
                    </ul>
                </div>
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Branch records affect imports, monitoring, and reporting.
                        </div>
                    </div>

                    <div class="form-panel">
                        <div class="mb-3">
                            <div class="fw-bold mb-1">Import Mapping</div>
                            <div class="text-muted small">
                                Branch setup helps the system identify spreadsheet sheet assignments and import destinations correctly.
                            </div>
                        </div>

                        <div class="mb-3">
                            <div class="fw-bold mb-1">Reporting Accuracy</div>
                            <div class="text-muted small">
                                Dashboard totals and transaction reports rely on correct branch master data.
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="text-muted small">
                                Branch status and business unit assignment affect access, monitoring scope, and reporting structure.
                            </div>
                        </div>
                    </div>
                </div>
