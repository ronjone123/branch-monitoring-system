        ...
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Add Business Unit</div>
                    <div class="mt-2 text-white-50">
                        Create a new business unit record and define its code, description, and operational status.
                    </div>
                </div>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="summary-card">
                    <div class="summary-section-header">
                        <h5>Business Unit Form</h5>
                        <div class="summary-section-subtitle">
                            Enter the required business unit details below.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <form action="{{ route('business-units.store') }}" method="POST">
                            ...
                            <div class="mt-4 d-flex gap-2 flex-wrap">
                                <button type="submit" class="btn btn-summary-primary">Save Business Unit</button>
            ...
            <div class="col-lg-4">
                <div class="helper-box mb-4">
                    ...
                    <ul>
                        <li>Use a clear and official business unit code.</li>
                        <li>Keep the business unit name aligned with company usage.</li>
                        <li>Add a short description for easier identification.</li>
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Business unit records affect branch assignment, reporting, and monitoring structure.
                        </div>
                    </div>

                    <div class="form-panel">
                        <div class="mb-3">
                            <div class="fw-bold mb-1">Reporting Structure</div>
                            <div class="text-muted small">
                                Dashboard summaries and organizational reporting depend on correct business unit records.
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-muted small">
                                Branches are linked to business units, so this setup affects how records are grouped in the system.
                            </div>
                        </div>

                        <div>
                            <div class="fw-bold mb-1">Future Expansion</div>
                            <div class="text-muted small">
                                Proper business unit setup makes it easier to support future modules and import logic.
                            </div>
                        </div>
                    </div>
                </div>
