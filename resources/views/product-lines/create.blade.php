        ...
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Add Product Line</div>
                    <div class="mt-2 text-white-50">
                        Create a new product line record and define its code, name, and operational status.
                    </div>
                </div>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="summary-card">
                    <div class="summary-section-header">
                        <h5>Product Line Form</h5>
                        <div class="summary-section-subtitle">
                            Enter the required product line details below.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <form action="{{ route('product-lines.store') }}" method="POST">
                            ...
                            @include('product-lines._form', ['productLine' => new \App\Models\ProductLine()])

                            <div class="mt-4 d-flex gap-2 flex-wrap">
                                <button type="submit" class="btn btn-summary-primary">Save Product Line</button>
            ...
            <div class="col-lg-4">
                <div class="helper-box mb-4">
                    ...
                    <ul>
                        <li>Use the official code and product line name.</li>
                        <li>Keep product line naming consistent with reporting and branch assignment.</li>
                        <li>Set the correct status before saving.</li>
                        <li>Product lines affect branch permissions and transaction mapping.</li>
                    </ul>
                </div>
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Product line records affect branch setup, imports, and reporting structure.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <div class="mb-3">
                            ...
                            <div class="text-muted small">
                                Branches may allow only selected product lines, so this setup affects branch configuration.
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-muted small">
                                Standardized product line records improve summaries, filters, and transaction grouping.
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="text-muted small">
                                Correct product line setup helps imports and business reporting stay aligned.
                            </div>
                        </div>
                    </div>
                </div>
