    ...
    <div class="summary-shell page-with-fixed-nav px-3 px-md-4 py-4">
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Product Line Details</div>
                    <div class="mt-2 text-white-50">
                        Review product line identity and operational status.
                    </div>
                </div>

                <div class="summary-date-box d-flex flex-column justify-content-center align-items-center px-4 py-4">
                    <div class="summary-date-label">Product Line Code</div>
                    <div class="summary-date-value">{{ $productLine->code }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div class="d-flex gap-2 flex-wrap">
                <a href="{{ route('product-lines.edit', $productLine) }}" class="btn btn-summary-primary">
                    Edit Product Line
                </a>
                <a href="{{ route('product-lines.index') }}" class="btn btn-outline-secondary btn-summary-outline">
                    Back to List
                </a>
            </div>
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $productLine->code }}</div>
                    <div class="summary-stat-sub">Unique product line identifier</div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $productLine->name }}</div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ ucfirst($productLine->status) }}</div>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="summary-card">
                    <div class="summary-section-header">
                        <h5>Product Line Information</h5>
                        <div class="summary-section-subtitle">
                            Core identity and operational information for this product line.
                        </div>
                    </div>
                    ...
                    <div class="p-4">
                        <div class="detail-list">
                            <div class="detail-item">
                                ...
                                <div class="detail-value">{{ $productLine->code }}</div>
                            </div>

                            <div class="detail-item">
                                <div class="detail-label">Name</div>
                                <div class="detail-value">{{ $productLine->name }}</div>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">Available for branch assignment and reporting configuration</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="helper-box mb-4">
                    <div class="helper-box-title">Product Line Notes</div>
                    <ul>
                        <li>Product lines are used in branch configuration and reporting structure.</li>
                        <li>Code and name should stay consistent with operational usage.</li>
                        <li>Status may affect whether the product line is selectable in admin workflows.</li>
                    </ul>
                </div>
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Quick review of product line setup.
                        </div>
                    </div>
                    ...
                    <div class="p-4">
                        <div class="detail-list">
                            ...
                            <div class="detail-item">
                                <div class="detail-label">Status</div>
                                <div class="detail-value">{{ ucfirst($productLine->status) }}</div>
                            </div>
