        ...
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Edit Category</div>
                    <div class="mt-2 text-white-50">
                        Update category identity, product line assignment, and operational status.
                    </div>
                </div>
        ...
        <div class="row g-4">
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Review and update the category information below.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <form action="{{ route('categories.update', $category) }}" method="POST">
                            ...
                            <div class="mt-4 d-flex gap-2 flex-wrap">
                                <button type="submit" class="btn btn-summary-primary">Update Category</button>
            ...
            <div class="col-lg-4">
                <div class="meta-card mb-4">
                    ...
                    <div class="meta-value">{{ $category->code ?? '-' }}</div>
                </div>
                ...
                <div class="meta-card mb-4">
                    ...
                    <div class="meta-value">{{ ucfirst($category->status ?? 'active') }}</div>
                </div>

                <div class="helper-box mb-4">
                    <div class="helper-box-title">Edit Guidance</div>
                    <ul>
                        <li>Keep the category aligned with the correct product line.</li>
                        <li>Review code and name carefully before saving updates.</li>
                        <li>Status changes may affect category availability in imports and reporting.</li>
                    </ul>
                </div>
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Category records affect grouping, imports, and reporting consistency.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <div class="mb-3">
                            ...
                            <div class="text-muted small">
                                Categories help organize products under the correct product line structure.
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-muted small">
                                Consistent category setup improves transaction grouping, filters, and summaries.
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="text-muted small">
                                Proper category records help imports and mapped data stay aligned across the system.
                            </div>
                        </div>
                    </div>
                </div>
