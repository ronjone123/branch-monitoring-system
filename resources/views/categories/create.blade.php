        ...
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Add Category</div>
                    <div class="mt-2 text-white-50">
                        Create a new category record and assign it to the correct product line.
                    </div>
                </div>
        ...
        <div class="row g-4">
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Enter the required category details below.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <form action="{{ route('categories.store') }}" method="POST">
                            ...
                            <div class="mt-4 d-flex gap-2 flex-wrap">
                                <button type="submit" class="btn btn-summary-primary">Save Category</button>
            ...
            <div class="col-lg-4">
                <div class="helper-box mb-4">
                    ...
                    <ul>
                        <li>Assign the category to the correct product line.</li>
                        <li>Use a clear and consistent category name.</li>
                        <li>Keep the category code aligned with current business usage if applicable.</li>
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Category records affect product grouping, imports, and reporting structure.
                        </div>
                    </div>
                    ...
                    <div class="form-panel">
                        <div class="mb-3">
                            ...
                            <div class="text-muted small">
                                Categories help define how products are organized under each product line.
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-muted small">
                                Standardized category records improve summaries, transaction grouping, and filtering.
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="text-muted small">
                                Correct category setup supports better mapping and cleaner transaction reporting.
                            </div>
                        </div>
                    </div>
                </div>
