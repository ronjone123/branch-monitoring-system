    ...
    <div class="summary-shell page-with-fixed-nav px-3 px-md-4 py-4">
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Category Details</div>
                    <div class="mt-2 text-white-50">
                        Review category identity, product line assignment, and operational status.
                    </div>
                </div>

                <div class="summary-date-box d-flex flex-column justify-content-center align-items-center px-4 py-4">
                    <div class="summary-date-label">Category Code</div>
                    <div class="summary-date-value">{{ $category->code ?? '-' }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div class="d-flex gap-2 flex-wrap">
                <a href="{{ route('categories.edit', $category) }}" class="btn btn-summary-primary">
                    Edit Category
                </a>
                <a href="{{ route('categories.index') }}" class="btn btn-outline-secondary btn-summary-outline">
                    Back to List
                </a>
            </div>
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-4">
                <div class="summary-stat">
                    <div class="summary-stat-label">Code</div>
                    <div class="summary-stat-value">{{ $category->code ?? '-' }}</div>
                    <div class="summary-stat-sub">Category code used for internal reference</div>
                </div>
            </div>

            <div class="col-md-4">
                <div class="summary-stat">
                    <div class="summary-stat-label">Name</div>
                    <div class="summary-stat-value">{{ $category->name }}</div>
                    <div class="summary-stat-sub">Display name used across the system</div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ ucfirst($category->status) }}</div>
                    <div class="summary-stat-sub">Current operational status</div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Core identity and product line linkage for this category.
                        </div>
                    </div>
                        ...
                        <div class="detail-list">
                            <div class="detail-item">
                                ...
                                <div class="detail-value">
                                    ...
                                    @if($category->productLine?->code)
                                        ({{ $category->productLine->code }})
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">{{ $category->code ?? '-' }}</div>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">
                                    <span class="soft-badge {{ $category->status === 'active' ? 'success' : 'warning' }}">
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">Available for product grouping, imports, and reporting configuration</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="helper-box mb-4">
                    <div class="helper-box-title">Category Notes</div>
                    <ul>
                        <li>Categories are linked to product lines for structured product grouping.</li>
                        <li>Name and code should remain consistent with operational references.</li>
                        <li>Status may affect category visibility in admin workflows and imports.</li>
                    </ul>
                </div>
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Quick review of category setup.
                        </div>
                    </div>
                    ...
                    <div class="p-4">
                        <div class="detail-list">
                            <div class="detail-item">
                                <div class="detail-label">Product Line</div>
                                <div class="detail-value">{{ $category->productLine->name ?? '-' }}</div>
                            </div>

                            <div class="detail-item">
                                <div class="detail-label">Status</div>
                                <div class="detail-value">{{ ucfirst($category->status) }}</div>
                            </div>
