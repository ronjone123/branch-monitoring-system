<x-app-layout>
    ...
    <div class="summary-shell page-with-fixed-nav px-3 px-md-4 py-4">
        ...
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Categories</div>
                    <div class="mt-2 text-white-50">
                        Manage category master records, product line relationships, codes, and operational status.
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-end mb-4">
            <a href="{{ route('categories.create') }}" class="btn btn-summary-primary">
                Add Category
            </a>
        </div>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-4">
                <div class="summary-stat">
                    <div class="summary-stat-label">Total Categories</div>
                    <div class="summary-stat-value">{{ $categories->total() }}</div>
                    <div class="summary-stat-sub">All category records currently listed in the system</div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $categories->currentPage() }}</div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $categories->count() }}</div>
                    <div class="summary-stat-sub">Number of categories shown on this page</div>
                </div>
            </div>
        </div>
        ...
        <div class="summary-card">
            <div class="summary-section-header">
                ...
                <div class="summary-section-subtitle">
                    Review product line assignments, category codes, names, and current status.
                </div>
            </div>

            <div class="summary-toolbar d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                <div class="text-muted small">
                    Showing <strong>{{ $categories->count() }}</strong> record(s) on this page out of
                    <strong>{{ $categories->total() }}</strong> total
                </div>
            </div>
                        ...
                        <tbody>
                            @forelse($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <span class="soft-badge secondary">{{ $category->code ?? '-' }}</span>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <div class="action-group">
                                            <a href="{{ route('categories.show', $category) }}" class="btn btn-sm btn-outline-secondary btn-summary-outline-sm">
                                                View
                                            </a>
                                            <a href="{{ route('categories.edit', $category) }}" class="btn btn-sm btn-outline-primary btn-summary-outline-sm">
                                                Edit
                                            </a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="5" class="p-0">
                                        <div class="empty-state">
                                            ...
                                            <div>No category master records are available yet.</div>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
