    ...
    <div class="summary-shell page-with-fixed-nav px-3 px-md-4 py-4">
        <div class="mb-4">
            <div class="summary-hero d-flex flex-column flex-lg-row justify-content-between align-items-stretch">
                <div class="flex-grow-1 p-4 p-lg-5">
                    <div class="summary-hero-title">Brand Details</div>
                    <div class="mt-2 text-white-50">
                        Review brand identity, product line assignment, and operational status.
                    </div>
                </div>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div class="d-flex gap-2 flex-wrap">
                <a href="{{ route('brands.edit', $brand) }}" class="btn btn-summary-primary">
                    Edit Brand
                </a>
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $brand->code ?? '-' }}</div>
                    <div class="summary-stat-sub">Brand code used for internal reference</div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ $brand->name }}</div>
            ...
            <div class="col-md-4">
                <div class="summary-stat">
                    ...
                    <div class="summary-stat-value">{{ ucfirst($brand->status) }}</div>
        ...
        <div class="row g-4">
                ...
                <div class="summary-card">
                    <div class="summary-section-header">
                        ...
                        <div class="summary-section-subtitle">
                            Core identity and product line linkage for this brand.
                        </div>
                    </div>
                        ...
                        <div class="detail-list">
                            <div class="detail-item">
                                ...
                                <div class="detail-value">
                                    {{ $brand->productLine->name ?? '-' }}
                                    @if($brand->productLine?->code)
                                        ({{ $brand->productLine->code }})
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">{{ $brand->code ?? '-' }}</div>
                            </div>
                            ...
                            <div class="detail-item">
                                ...
                                <div class="detail-value">
                                    <span class="soft-badge {{ $brand->status === 'active' ? 'success' : 'warning' }}">
            ...
            <div class="col-lg-4">
                <div class="helper-box mb-4">
                    <div class="helper-box-title">Brand Notes</div>
                    <ul>
                        <li>Brands are linked to product lines for structured product grouping.</li>
                        <li>Name and code should remain consistent with operational references.</li>
                        <li>Status may affect brand visibility in admin workflows and imports.</li>
                    </ul>
                </div>
                ...
                <div class="summary-card">
                    ...
                    <div class="p-4">
                        <div class="detail-list">
                            <div class="detail-item">
                                <div class="detail-label">Product Line</div>
                                <div class="detail-value">{{ $brand->productLine->name ?? '-' }}</div>
                            </div>

                            <div class="detail-item">
                                <div class="detail-label">Status</div>
                                <div class="detail-value">{{ ucfirst($brand->status) }}</div>
                            </div>
